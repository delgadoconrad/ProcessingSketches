...
void setup() {
  ...
  PImage friends = loadImage("Beast.png");  // 2. Change this to match the name of your photo. 
  size(friends.width, friends.height);
  // 3. Set your friends as tSickPhotohe background. 
 background(friends);
  // 4. Find an image of a mustache, and drop it onto this sketch. 
  mustache = loadImage("Mustach.png"); // 5. Change this to match your file name.
}
...
void draw() {
  ...
  image(mustache, mouseX-255, mouseY-65);
  }
